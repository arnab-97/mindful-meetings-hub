...
import { getEvent, getSpeaker, getVenue, formatPrice, formatDate, formatTime } from "@/data/mockData";
            ...
            {speaker && (
              <div className="rounded-xl border border-border bg-card p-6">
                ...
                <div className="flex gap-4">
                  <img src={speaker.headshot_url} alt={speaker.name} className="h-16 w-16 rounded-full object-cover" />
                  <div>
